...
def policy_kwargs_building(data):
    ...
    if data["algo_params"]["policy_type"] == "on_policy":
        net_arch["pi"] = [int(data["algo_params"]["policy_kwargs"]["pi"]),
                          int(data["algo_params"]["policy_kwargs"]["pi"])]
        net_arch["vf"] = [int(data["algo_params"]["policy_kwargs"]["vf"]),
                          int(data["algo_params"]["policy_kwargs"]["vf"])]
